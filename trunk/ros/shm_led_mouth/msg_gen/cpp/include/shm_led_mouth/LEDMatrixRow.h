/* Auto-generated by genmsg_cpp for file /home/meka/mekabot/LED_MOUTH/m3ens/ros/shm_led_mouth/msg/LEDMatrixRow.msg */
...
struct LEDMatrixRow_ {
  ...
  typedef  ::shm_led_mouth::LEDMatrixRGB_<ContainerAllocator>  _column_type;
   ::shm_led_mouth::LEDMatrixRGB_<ContainerAllocator>  column;
...
template<class ContainerAllocator> struct IsFixedSize< ::shm_led_mouth::LEDMatrixRow_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
struct Printer< ::shm_led_mouth::LEDMatrixRow_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::shm_led_mouth::LEDMatrixRow_<ContainerAllocator> & v) 
  {
    s << indent << "column: ";
s << std::endl;
    Printer< ::shm_led_mouth::LEDMatrixRGB_<ContainerAllocator> >::stream(s, indent + "  ", v.column);
  }
};
