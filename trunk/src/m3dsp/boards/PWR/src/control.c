...
float curr_deg=0;
int des_pwm=0;
int mode_armh=0;//0: pwm, 1: ctrl
int ijk=0;
void step_control_armh()
{
	float x,y,err;
	float res;
	ec_debug[0]=PinFwd<<2|PinRev<<1|PinZero;
	...
	{
		if (PinFwd)
			des_deg=MIN(des_deg+ARMH_DELTA,ARMH_Q_MAX);
		if (PinRev)
			des_deg=MAX(des_deg-ARMH_DELTA,ARMH_Q_MIN);
		curr_deg = (float)qei_position()*QEI_DEG_PER_PULSE;
		err = des_deg-curr_deg;
		res=CLAMP(ARMH_K_P*err,(float)-ARMH_PWM_MAX,(float)ARMH_PWM_MAX);
		set_pwm(0,(int)res);
...
#if defined M3_BMA_A1R1 || defined M3_WMA_0_1 || defined M3_GMB_G1R1 || defined M3_HMB_H1R1 || defined M3_HB2_H2R1_J0J1 \
	|| defined M3_HB2_H2R1_J2J3J4 || defined M3_HB2_H2R2_J0J1 || defined M3_HB2_H2R2_J2J3J4 || defined M3_MAX2 || \
	defined M3_BMW_A2R1 || defined M3_BMW_A2R2 || defined M3_HEX2_S1R1 || defined M3_HEX4_S2R1  || defined M3_BMW_A2R3 \
...
#if defined M3_BMA_A1R1 || defined M3_WMA_0_1 || defined M3_DAC_0_1 || defined M3_ELMO_RNA_R0 || defined M3_MAX2 || \
	defined M3_HMB_H1R1 || defined M3_HB2_H2R1_J0J1 || defined M3_HB2_H2R1_J2J3J4 || defined M3_HB2_H2R2_J0J1 || \
	defined M3_HB2_H2R2_J2J3J4 || defined M3_GMB_G1R1  || defined M3_BMW_A2R1 || defined M3_BMW_A2R2 || defined M3_HEX2_S1R1 \
...
# if defined M3_HEX4_S2R1 || defined M3_HEX2_S1R1 || defined M3_MAX2_BDC_S1R1
...
#if defined M3_HMB_H1R1 || defined M3_GMB_G1R1
	if (chid==0)
...
#if defined M3_MAX2_BLDC_MA3 || defined M3_MAX2_BDC_T2R1 || defined M3_MAX2_BLDC_T2R1 \
	|| defined M3_MAX2_BDC_T2R2 || defined M3_MAX2_BLDC_T2R2
	if (d->config&M3ACT_CONFIG_TORQUE_SMOOTH)
		s=get_avg_adc_torque();
	else
		s=adc_raw[ADC_EXT];
