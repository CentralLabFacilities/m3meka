...
#define	BB_ASPI_SS				LATBbits.LATB0		//RB0	OUTPUT	PIN21	SPI_SS_ADC/
#define	BB_ASPI_CLK				LATBbits.LATB15		//RB15	OUTPUT	PIN15	SPI_CLK_ADC
#define BB_PIN_ASPI_DI			PORTBbits.RB14		//RB14	INPUT	PIN14	SPI_DI_ADC
