...
#define BLDC_SWITCH_LO_LEG

#define BLDC_HALL_1 PORTBbits.RB4		//RB4	INPUT	PIN33	RP4/CN1 (HALL1) 
#define BLDC_HALL_2 PORTBbits.RB9		//RB9	INPUT	PIN1	RP9/CN21 (HALL3)
#define BLDC_HALL_3 PORTBbits.RB8		//RB8	INPUT	PIN44	RP8/CN22 (HALL2)
