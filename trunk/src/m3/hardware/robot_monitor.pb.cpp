...
const ::std::string M3RobotMonitorComponentStatus::_default_component_name_;
const ::std::string M3RobotMonitorComponentStatus::_default_msg_;
#ifndef _MSC_VER
...
void M3RobotMonitorComponentStatus::SharedCtor() {
  _cached_size_ = 0;
  component_name_ = const_cast< ::std::string*>(&_default_component_name_);
  state_ = 0;
...
void M3RobotMonitorComponentStatus::SerializeWithCachedSizes(
  ...
  if (raw_buffer != NULL) {
    M3RobotMonitorComponentStatus::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3RobotMonitorStatus::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3RobotMonitorStatus::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3RobotMonitorCommand::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3RobotMonitorCommand::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
const ::std::string M3RobotMonitorComponentParam::_default_component_name_;
#ifndef _MSC_VER
...
void M3RobotMonitorComponentParam::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3RobotMonitorComponentParam::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3RobotMonitorParam::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3RobotMonitorParam::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
