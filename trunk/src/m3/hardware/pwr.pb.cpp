...
void M3PwrStatus::SerializeWithCachedSizes(
  ...
  if (raw_buffer != NULL) {
    M3PwrStatus::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3PwrParam::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3PwrParam::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3PwrCommand::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3PwrCommand::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
