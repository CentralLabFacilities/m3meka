...
void M3LedX2XNEcStatus::SerializeWithCachedSizes(
  ...
  if (raw_buffer != NULL) {
    M3LedX2XNEcStatus::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3LedX2XNEcRGB::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3LedX2XNEcRGB::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3LedX2XNEcCommand::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3LedX2XNEcCommand::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3LedX2XNEcParam::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3LedX2XNEcParam::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
