...
void M3LedX2EcStatus::SerializeWithCachedSizes(
  ...
  if (raw_buffer != NULL) {
    M3LedX2EcStatus::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3LedX2EcRGB::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3LedX2EcRGB::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3LedX2EcBranch::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3LedX2EcBranch::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3LedX2EcCommand::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3LedX2EcCommand::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3LedX2EcParam::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3LedX2EcParam::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
