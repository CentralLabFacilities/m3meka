...
void M3PwrEcStatus::SerializeWithCachedSizes(
  ...
  if (raw_buffer != NULL) {
    M3PwrEcStatus::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3PwrEcCommand::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3PwrEcCommand::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
void M3PwrEcParam::SerializeWithCachedSizes(
  ...
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    M3PwrEcParam::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
