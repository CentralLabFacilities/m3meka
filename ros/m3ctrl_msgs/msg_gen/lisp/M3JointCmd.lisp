...
(cl:defmethod effort-val ((m <M3JointCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader m3ctrl_msgs-msg:effort-val is deprecated.  Use m3ctrl_msgs-msg:effort instead.")
  (effort m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<M3JointCmd>)))
  ...
  "7bc113ddddf00bf9378a6e9a94a186f0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'M3JointCmd)))
  "Returns md5sum for a message object of type 'M3JointCmd"
  "7bc113ddddf00bf9378a6e9a94a186f0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<M3JointCmd>)))
  ...
  (cl:format cl:nil "Header header~%uint8[] chain~%int16[] chain_idx~%float32[] stiffness~%float32[] velocity~%float32[] position~%float32[] effort~%uint8[] control_mode~%uint8[] smoothing_mode~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'M3JointCmd)))
  "Returns full string definition for message of type 'M3JointCmd"
  (cl:format cl:nil "Header header~%uint8[] chain~%int16[] chain_idx~%float32[] stiffness~%float32[] velocity~%float32[] position~%float32[] effort~%uint8[] control_mode~%uint8[] smoothing_mode~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
