...
public:
  ...
  RobotArm() 
  {
    ...
    traj_client_ = new TrajClient("right_arm_controller/joint_trajectory_action", true);
  ...
  */
  pr2_controllers_msgs::JointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.joint_names.push_back("m3joint_ma10_j0");
    goal.trajectory.joint_names.push_back("m3joint_ma10_j1");
    goal.trajectory.joint_names.push_back("m3joint_ma10_j2");
    goal.trajectory.joint_names.push_back("m3joint_ma10_j3");
    goal.trajectory.joint_names.push_back("m3joint_ma10_j4");
    goal.trajectory.joint_names.push_back("m3joint_ma10_j5");
    goal.trajectory.joint_names.push_back("m3joint_ma10_j6");
